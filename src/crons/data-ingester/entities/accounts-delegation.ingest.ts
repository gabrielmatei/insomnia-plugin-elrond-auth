  ...
  public async fetch(): Promise<Record<string, number>> {
    ...
    const [
      ...
      this.elasticService.getCount(
        ...
        `accounts-000001_${epoch}`,
        ElasticQuery.create().withFilter([
          new RangeQuery('delegationNum', { gt: 0.1 }),
        ])),
      this.elasticService.getCount(
        this.apiConfigService.getInternalElasticUrl(),
        `accounts-000001_${epoch}`,
        ElasticQuery.create().withFilter([
          new RangeQuery('delegationNum', { gt: 1 }),
        ])),
      this.elasticService.getCount(
        this.apiConfigService.getInternalElasticUrl(),
        `accounts-000001_${epoch}`,
        ElasticQuery.create().withFilter([
          new RangeQuery('delegationNum', { gt: 10 }),
        ])),
      this.elasticService.getCount(
        this.apiConfigService.getInternalElasticUrl(),
        `accounts-000001_${epoch}`,
        ElasticQuery.create().withFilter([
          new RangeQuery('delegationNum', { gt: 100 }),
        ])),
      this.elasticService.getCount(
        this.apiConfigService.getInternalElasticUrl(),
        `accounts-000001_${epoch}`,
        ElasticQuery.create().withFilter([
          new RangeQuery('delegationNum', { gt: 1000 }),
        ])),
      this.elasticService.getCount(
        this.apiConfigService.getInternalElasticUrl(),
        `accounts-000001_${epoch}`,
        ElasticQuery.create().withFilter([
          new RangeQuery('delegationNum', { gt: 10000 }),
        ])),
    ]);
